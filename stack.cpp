...
/**
 * Removes the object on top o  df the Stack, and returns it. That is, remove
...
//    for (unsigned j = num_items; j < max_items; j++){
//        temp[j] = 0;
//    }
    //  std::cout << max_items;
    delete []  items;
